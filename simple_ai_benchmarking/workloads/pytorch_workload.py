...
class PyTorchWorkload(AIWorkload):
    ...
    def setup(self) -> None:
        ...
        logger.debug("Synthetic Dataset PyTorch Inputs Shape: {} {}", self.inputs.shape, self.inputs.dtype)
        logger.debug("Synthetic Dataset PyTorch Targets Shape: {} {}", self.targets.shape, self.targets.dtype)
